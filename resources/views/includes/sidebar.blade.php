    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="admin-sumbangsaran.html" class="nav-link">
              <i class="nav-icon fab fa-audible"></i>
              <p>Kelola Sumbang Saran</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="admin-datakaryawan.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="admin-penilaian.html" class="nav-link">
              <i class="nav-icon fas fa-star-half-alt"></i>
              <p>Penilaian</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="admin-pesertaterbaik" class="nav-link">
